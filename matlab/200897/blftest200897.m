function [w, nd, v, lls]=blftest200897(xin, tin, niters, win, ndin, vin)

% BLFTEST190897 Train a network to patterns given by xin (target tin)
...
if nargin<4
  [w, nd, v]=blf200897(nrow1, nrow2, nrow3);
else
  w=win;
  v=vin;
  nd=ndin;
