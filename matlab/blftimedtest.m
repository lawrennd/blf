...
for k=1:niters
  ...
  for l=1:npatterns;
    ...
    t=cputime;v=mfupdate(w, nd, v, tol); disp(['mfupdate: ' num2str(cputime-t)])
    %t=cputime; v=blfxiopt(w, nd, v, tol); disp(['blfxiopt: ' num2str(cputime-t)])
    %t=cputime; v=blfmuopt(w, nd, v, 4); disp(['blfmuopt: ' num2str(cputime-t)])

    t=cputime; lls(l, k)=blfll(w, nd, v); disp(['blfll: ' num2str(cputime-t)])
    t=cputime; wg=blfgrad(w, nd, v); disp(['blfgrad: ' num2str(cputime-t)])
    w=w+learnrate*wg;
