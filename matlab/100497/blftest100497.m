function [w, nd, v, lls]=blftest100497(xin, niters)

%BLFTEST100497 Train a network to patterns given by xin for niters iterations
%
%      Descrtiption
%      This test was for creating a genrative model for Chris' research
%      proposal. It was performed using my preprocessing of the USPS data on
%      2s.
